...
public class Main {
    ...
    public static void runTestLab2(int N, int M, int k, int[] threadCounts) {
        System.out.println("\n" + "=".repeat(60));
    ...
    public static void main(String[] args){
        ...
        if (choice == 1) {
            ...
            runTestLab2(10, 10, 3, new int[]{2});

            // Test 2: N=M=1000, k=3, p=2,4,8,16
            runTestLab2(1000, 1000, 3, new int[]{2, 4, 8, 16});

            // Test 3: N=M=10000, k=3, p=2,4,8,16
            runTestLab2(10000, 10000, 3, new int[]{2, 4, 8, 16});
